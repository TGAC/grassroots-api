...
*/
    ...
    #define GRASSROOTS_PARAMS_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define GRASSROOTS_PARAMS_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef GRASSROOTS_PARAMS_MANAGER_LIBRARY_EXPORTS */
  #define GRASSROOTS_PARAMS_LOCAL LIB_HELPER_SYMBOL_LOCAL
#else /* SHARED_LIBRARY is not defined: this means LIB is a static lib. */
  #define GRASSROOTS_PARAMS_API
  #define GRASSROOTS_PARAMS_LOCAL
...
#endif 	/* #ifndef GRASSROOTS_PARAMS_LIBRARY_H */
