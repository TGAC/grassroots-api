...
*/
  ...
  #ifdef  GRASSROOTS_NETWORK_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define GRASSROOTS_NETWORK_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define GRASSROOTS_NETWORK_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef GRASSROOTS_NETWORK_LIBRARY_EXPORTS */
  #define GRASSROOTS_NETWORK_LOCAL LIB_HELPER_SYMBOL_LOCAL
...
#endif 	/* #ifndef GRASSROOTS_NETWORK_LIBRARY_H */
