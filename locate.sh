...
FILENAME=oauth\.h
LookUp $FILENAME
OAUTH_INC_DIR="$(dirname "$VAR_DIR" )"
echo "Using $VAR_DIR for $FILENAME"


echo ">>> OAUTH LIB"
FILENAME=liboauth\.so
LookUp $FILENAME
OAUTH_LIB_DIR=$VAR_DIR
echo "Using $VAR_DIR for $FILENAME"
...
echo "OAUTH_LIB_DIR: $OAUTH_LIB_DIR"
echo "OAUTH_INC_DIR: $OAUTH_INC_DIR"
