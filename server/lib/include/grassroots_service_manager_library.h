...
*/
  ...
  #ifdef  GRASSROOTS_SERVICE_MANAGER_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define GRASSROOTS_SERVICE_MANAGER_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define GRASSROOTS_SERVICE_MANAGER_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef GRASSROOTS_SERVICE_MANAGER_LIBRARY_EXPORTS */
  #define GRASSROOTS_SERVICE_MANAGER_LOCAL LIB_HELPER_SYMBOL_LOCAL
...
#endif 	/* #ifndef GRASSROOTS_SERVER_LIBRARY_H */
