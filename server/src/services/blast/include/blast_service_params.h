...
BLAST_SERVICE_PREFIX NamedParameterType BS_WORD_SIZE BLAST_SERVICE_VAL (SET_NAMED_PARAMETER_TYPE_TAGS ("word_size", PT_UNSIGNED_INT));
...
BLAST_SERVICE_PREFIX NamedParameterType BS_MATCH_SCORE BLAST_SERVICE_VAL (SET_NAMED_PARAMETER_TYPE_TAGS ("match_score", PT_SIGNED_INT));
BLAST_SERVICE_PREFIX NamedParameterType BS_MISMATCH_SCORE BLAST_SERVICE_VAL (SET_NAMED_PARAMETER_TYPE_TAGS ("mismatch_score", PT_SIGNED_INT));
