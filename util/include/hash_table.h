 ...
 */
WHEATIS_UTIL_API void FreeHashBucket (HashBucket * const bucket_p);
 ...
 */
WHEATIS_UTIL_API HashBucket *CreateHashBuckets (const uint32 num_buckets, const MEM_FLAG key_mem_flag, const MEM_FLAG value_mem_flag);


WHEATIS_UTIL_API HashBucket *CreateDeepCopyHashBuckets (const uint32 num_buckets);

WHEATIS_UTIL_API HashBucket *CreateShallowCopyHashBuckets (const uint32 num_buckets);

WHEATIS_UTIL_API HashBucket *CreateShadowUseHashBuckets (const uint32 num_buckets);


WHEATIS_UTIL_API HashBucket *CreateDeepCopyKeysShallowCopyValueHashBuckets (const uint32 num_buckets);
 ...
 */
WHEATIS_UTIL_API HashTable *AllocateHashTable (const uint32 initial_size,
 ...
 */
WHEATIS_UTIL_API void FreeHashTable (HashTable * const hash_table_p);
 ...
 */
WHEATIS_UTIL_API void ClearHashTable (HashTable * const hash_table_p);
 ...
 */
WHEATIS_UTIL_API bool IsValidHashBucket (const HashBucket * const bucket_p);
 ...
 */
WHEATIS_UTIL_API bool PutInHashTable (HashTable * const hash_table_p, const void * const key_p, const void * const value_p);
 ...
 * given key.
 */
WHEATIS_UTIL_API const void *GetFromHashTable (const HashTable * const hash_table_p, const void * const key_p);


WHEATIS_UTIL_API void **GetKeysIndexFromHashTable (const HashTable * const hash_table_p);

WHEATIS_UTIL_API void FreeKeysIndex (void **index_pp);
 ...
 * @param key_p The key.
 */
WHEATIS_UTIL_API void RemoveFromHashTable (HashTable * const hash_table_p, const void * const key_p);
 ...
 */
WHEATIS_UTIL_API void PrintHashTable (const HashTable * const hash_table_p, OutputStream * const stream_p);
 ...
 */
WHEATIS_UTIL_API HashTable *CopyHashTable (const HashTable * const src_table_p, const bool deep_copy_if_necessary);


WHEATIS_UTIL_API bool SaveHashTable (const HashTable * const table_p, const char * const filename_s, int (*compare_fn) (const void *v0_p, const void *v1_p));


WHEATIS_UTIL_API bool LoadHashTable (HashTable * const table_p, char *current_path_s, const char * const filename_s);


WHEATIS_UTIL_API uint32 GetHashTableSize (const HashTable * const table_p);
