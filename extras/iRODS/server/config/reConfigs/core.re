...
acPostProcForPut { PythonObjectRegistered($userNameClient,$rescVaultPath,$collName,$objPath); }
acPostProcForCopy { }
acPostProcForFilePathReg { PythonObjectRegistered($userNameClient,$rescVaultPath,$collName,$objPath); }
acPostProcForCreate { }
