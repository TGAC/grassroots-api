 ...
 **********************************************************************
 *
 * $Id: SQLBrowseConnect.c,v 1.12 2005/11/21 17:25:43 lurcher Exp $
 *
...
static char const rcsid[]= "$RCSfile: SQLBrowseConnect.c,v $ $Revision: 1.12 $";
    ...
    if ( ret == SQL_NEED_DATA )
    {
        ...
        if ( log_info.log_flag )
        {
            sprintf( connection -> msg, 
                    ...
                    __sptr_as_string( s2, ptr_conn_str_out ));
