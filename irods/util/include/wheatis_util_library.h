...
*/
  ...
  #ifdef  WHEATIS_UTIL_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define WHEATIS_UTIL_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define WHEATIS_UTIL_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef WHEATIS_UTIL_LIBRARY_EXPORTS */
  #define WHEATIS_UTIL_LOCAL LIB_HELPER_SYMBOL_LOCAL
#else /* SHARED_LIBRARY is not defined: this means LIB is a static lib. */
  #define WHEATIS_UTIL_API
  #define WHEATIS_UTIL_LOCAL
