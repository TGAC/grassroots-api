...
QTParameterWidget :: QTParameterWidget (const char *name_s, LinkedList * const parameters_p, const PrefsWidget * const prefs_widget_p, const ParameterLevel initial_level)
