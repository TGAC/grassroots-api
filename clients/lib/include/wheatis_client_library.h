/**
 * @file wheatis_client_library.h
 *
 * @defgroup Client Client Library
 * @page Client Client Library
 */

#ifndef WHEATIS_CLIENT_LIBRARY_H
#define WHEATIS_CLIENT_LIBRARY_H
...
*/
  ...
  #ifdef  WHEATIS_CLIENT_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define WHEATIS_CLIENT_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define WHEATIS_CLIENT_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef WHEATIS_CLIENT_MANAGER_LIBRARY_EXPORTS */
...
#endif 	/* #ifndef WHEATIS_CLIENT_LIBRARY_H */
