...
#ifndef GRASSROOTS_QT_CLIENT_LIBRARY_H
#define GRASSROOTS_QT_CLIENT_LIBRARY_H
...
*/
	...
	#ifdef  GRASSROOTS_QT_CLIENT_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
		#define GRASSROOTS_CLIENT_API LIB_HELPER_SYMBOL_EXPORT
	#else
		#define GRASSROOTS_CLIENT_API LIB_HELPER_SYMBOL_IMPORT
	#endif /* #ifdef GRASSROOTS_QT_CLIENT_LIBRARY_EXPORTS */
...
#endif 	/* #ifndef GRASSROOTS_QT_CLIENT_LIBRARY_H */
