...
*/
  ...
  #ifdef  WHEATIS_SERVICE_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define WHEATIS_SERVICE_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define WHEATIS_SERVICE_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef WHEATIS_SERVICE_MANAGER_LIBRARY_EXPORTS */
  #define WHEATIS_SERVICE_LOCAL LIB_HELPER_SYMBOL_LOCAL
#else /* SHARED_LIBRARY is not defined: this means LIB is a static lib. */
  #define WHEATIS_SERVICE_API
  #define WHEATIS_SERVICE_LOCAL
...
#endif 	/* #ifndef WHEATIS_SERVICE_LIBRARY_H */
